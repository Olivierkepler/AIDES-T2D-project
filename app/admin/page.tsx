...
export default async function AdminHome() {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      <Link href="/admin/users" className="rounded-2xl border bg-white p-6 shadow-sm hover:bg-slate-50">
        <h2 className="text-lg font-semibold">Users</h2>
        <p className="mt-1 text-sm text-slate-600">View, deactivate, or delete accounts.</p>
      </Link>

      <Link href="/admin/invites" className="rounded-2xl border bg-white p-6 shadow-sm hover:bg-slate-50">
